    ...
    @if(session('sukses'))
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <button type="button" class="btn btn-primary btn-sm my-2 my-sm-0 float-right" data-toggle="modal" data-target="#exampleModal">
                Tambah Data
                </button>
        ...
        <a href="/mahasiswa/exportpdf" class = "btn btn-success btn-sm">Export To PDF</a>
    </div>
</div>
    <!-- Modal -->
